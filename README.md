...
npx ctx commit -c "Fixes #123"

# Add context about a breaking change
npx ctx commit --context "Breaking change: removed deprecated API"

# Combine with other options
npx ctx commit -a --context "Security fix for CVE-2024-1234" --dry-run
```
